...
BASE_DIR = "C:/Users/Mritunjay Sharma/Documents/Face Recognition/src"
...
for root, dirs,files in os.walk(image_dir):
	for file in files:
		if file.endswith("png") or file.endswith("jpg"):
			...
			#x_train.append(path)   # verify this image,turn into in an numpy array,Gray
			...
			for(x,y,w,h) in faces:
				...
				x_train.append(roi)
				y_labels.append(id_) #number form
